...
#stripe test sk; TODO change to live
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '13.57.79.116', 'https://cappellacatalogue.com', 'https://www.cappellacatalogue.com',]
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, '_static/') #for [./manage.py collectstatic]
